    ...
    return (
        <div>
            <div className='d-flex align-items-center justify-content-between'>
                ...
                <button className='bg-transparent border-0 d-flex align-items-center gap-1 fs-5 mb-0 ' onClick={goBack}>
            ...
            <div className="mt-5 p-4 bg-white rounded-3">
                ...
                <div className='d-flex align-items-center gap-3 mb-2'>
                    ...
                    <a href={`tel:{EnquiryMobile}`} className='mb-0 text-decoration-none'>{EnquiryMobile}</a>
                </div>
                <div className='d-flex align-items-center gap-3 mb-2'>
